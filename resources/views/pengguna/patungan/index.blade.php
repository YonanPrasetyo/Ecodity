        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        {{-- patungan --}}
                        <button class="btn btn-xs btn-default text-primary mx-1 shadow btn-patungan"
                                title="Patungan"
                                data-toggle="modal"
                                data-target="#modalPatungan"
                                data-id="{{ $item['id_patungan'] }}"
                                data-komoditas="{{ $item['komoditas']['nama_komoditas'] }}"
                                data-satuan="{{ $item['komoditas']['satuan'] }}"
                                data-harga="{{ $item['komoditas']['harga_per_satuan'] }}"
                                data-sisa="{{ $item['total'] - $item['total_terkumpul'] }}">
...
@include('pengguna.patungan.patungan')
@endsection
